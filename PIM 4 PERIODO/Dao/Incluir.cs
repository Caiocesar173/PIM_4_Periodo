...
namespace PIM_4_PERIODO.Dao
{
    class Incluir
    {
        ...
        public void Abastecimento(Abastecimento Abastecimento)
        {
            try
            {
                string InsertAbastecimento = "INSERT INTO ABASTECIMENTO(KM_NO_ABASTECIMENTO, LITROS, VALOR, ID_POSTO, ID_VEICULO, DATA) VALUES (@KM_NO_ABASTECIMENTO, @LITROS, @VALOR, @ID_POSTO, @ID_VEICULO, @DATA);";
